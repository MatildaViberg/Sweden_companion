...
import { ArrowLeft, CheckCircle2, Lightbulb, ListOrdered, MessageCircle, X, ExternalLink, Search, AlertTriangle } from 'lucide-react';
          ...
          <>
            ...
            <div className="text-center py-6">
                 <p className="text-xs text-gray-400 dark:text-gray-500 flex items-center justify-center gap-2">
                    ...
                    Disclaimer: Content generated by AI. This application can make mistakes.
                 </p>
            </div>
          </>
        )}
