        ...
        {isLoading && (
          <div className="flex justify-start">
            <div className="bg-white p-4 rounded-2xl rounded-tl-none border border-gray-100 shadow-sm flex items-center gap-2">
               <div className="w-2 h-2 bg-sweden-blue rounded-full animate-bounce"></div>
               <div className="w-2 h-2 bg-sweden-blue rounded-full animate-bounce delay-100"></div>
               <div className="w-2 h-2 bg-sweden-blue rounded-full animate-bounce delay-200"></div>
            </div>
          </div>
        )}
        ...
        <div className="px-4 py-2 bg-gray-50 flex gap-2 overflow-x-auto scrollbar-hide">
          {SUGGESTED_QUESTIONS.map((q, idx) => (
            <button
              ...
              className="whitespace-nowrap bg-white border border-blue-200 text-sweden-blue text-xs py-1.5 px-3 rounded-full hover:bg-blue-50 transition"
            >
              {q}
            </button>
          ))}
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        <div className="flex gap-2 relative">
          <input
            ...
            className="flex-1 p-3 pr-12 bg-gray-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-sweden-blue text-gray-700"
          />
          <button 
            onClick={() => handleSend()}
